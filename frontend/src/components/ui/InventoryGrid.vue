    ...
    <v-container>
        ...
        <div class="panel">
            <div class="gs-bundle-of-buttons" style="max-height:10vh;">
                ...
                <v-btn style="margin-left: 5px;" @click="decreaseStockDialog = true" class="contrast-primary-text" small color="primary" >
...
export default {
    ...
    methods:{
        decreaseStock(params){
            try{
                this.repository.invoke(this.getSelectedItem(), "decreaseStock", params)
